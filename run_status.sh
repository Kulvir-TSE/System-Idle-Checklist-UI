...
sudo mkdir /home/gor/SystemIdle/backup_data
sudo chmod 777 /home/gor/SystemIdle/backup_data
sudo tar -cf "/home/gor/SystemIdle/backup_data/$(date +"%Y-%m-%d_%H-%M-%S")_backup_data.tar" -C /home/gor/SystemIdle/texts .
sudo rm /home/gor/SystemIdle/texts/*
